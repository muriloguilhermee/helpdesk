...
import ReturnFromN2 from './pages/ReturnFromN2';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="tickets/retorno-n2" element={<ProtectedRoute requiredPermission="view:pending:tickets"><ReturnFromN2 /></ProtectedRoute>} />
